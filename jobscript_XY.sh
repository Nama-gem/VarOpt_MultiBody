...
PYTHON_SCRIPT="${PROJECT_DIR}/cluster_optimization_XY.py"
...
echo
echo "Starting XY cluster optimization..."
echo
...
if [[ ${EXIT_CODE} -eq 0 ]]; then
    echo "XY optimization task completed successfully."
else
    echo "ERROR: XY optimization task exited with code ${EXIT_CODE}"
fi
